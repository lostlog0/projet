...
void MaFenetre::ouvrirDialogue(string valeur, string ip_recu)
{
    ...
    QString fichier = "/home/ubuntu/nouveauprojetmaiscettefoiscavamarcher/monFichier.txt";
...
void MaFenetre::slotOpenUrl() {
    ...
    QDesktopServices::openUrl(QUrl("/home/ubuntu/nouveauprojetmaiscettefoiscavamarcher/monFichier.txt"));
